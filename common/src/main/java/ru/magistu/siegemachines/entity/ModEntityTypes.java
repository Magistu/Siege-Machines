...
public class ModEntityTypes {
    ...
    public static final RegistrySupplier<EntityType<Cannonball>> CANNONBALL = addRegistry("cannonball", Cannonball::new, 1.0f, 1.0f, 20);
    public static final RegistrySupplier<EntityType<Stone>> STONE = addRegistry("stone", Stone::new, 1.0f, 1.0f, 20);
    public static final RegistrySupplier<EntityType<GiantStone>> GIANT_STONE = addRegistry("giant_stone", GiantStone::new, 2.0f, 2.0f, 20);
