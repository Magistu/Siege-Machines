...
public class SiegeWorkbenchRecipe implements IShapedRecipe<CraftingContainer> 
{
    ...
    public NonNullList<CountIngredient> getIngredientsGrid(boolean mirrored)
    {
        NonNullList<CountIngredient> nonnulllist = NonNullList.withSize(9, CountIngredient.of(Ingredient.EMPTY));
        ...
        for (int i = 0; i < 3; ++i)
        {
            for (int j = 0; j < 3; ++j)
            {
                ...
                nonnulllist.set(i + j * 3, ingredient);
            }
        }
