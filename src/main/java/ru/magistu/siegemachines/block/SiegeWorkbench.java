...
{
    private static final TranslatableComponent CONTAINER_TITLE = new TranslatableComponent("container.crafting");
    ...
    public @NotNull InteractionResult use(@NotNull BlockState blockstate, Level level, @NotNull BlockPos blockpos, @NotNull Player player, @NotNull InteractionHand hand, @NotNull BlockHitResult result)
    {
        ...
        {
            NetworkHooks.openGui((ServerPlayer) player, this.getMenuProvider(blockstate, level, blockpos));
