...
public class SiegeWorkbenchRecipe implements ISiegeWorkbenchRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingContainer>
{
    ...
    public static class SiegeWorkbenchRecipeType implements RecipeType<SiegeWorkbenchRecipe>
    {
        @Override
    ...
    public static class TagStackList extends Ingredient.TagValue
    {
        private final int count;

        public TagStackList(TagKey<Item> p_i48193_1_, int count)
        {
            super(p_i48193_1_);
            this.count = count;
        }
    ...
    public static Ingredient.Value valueFromJson(JsonObject p_199803_0_)
    {
        int count = GsonHelper.getAsInt(p_199803_0_, "count", 1);
        ...
        {
            ResourceLocation resourcelocation1 = new ResourceLocation(GsonHelper.getAsString(p_199803_0_, "item"));
        ...
        {
            ResourceLocation resourcelocation = new ResourceLocation(GsonHelper.getAsString(p_199803_0_, "tag"));
    ...
    public static Ingredient ingredientFromJson(@Nullable JsonElement p_199802_0_)
    {
        if (p_199802_0_ != null && !p_199802_0_.isJsonNull())
        {
            ...
            else if (p_199802_0_.isJsonArray())
            {
                ...
                {
                    return Ingredient.fromValues(StreamSupport.stream(jsonarray.spliterator(), false).map((p_209355_0_) -> valueFromJson(GsonHelper.convertToJsonObject(p_209355_0_, "item"))));
                }
            }
            else
            {
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<RecipeSerializer<?>>  implements RecipeSerializer<SiegeWorkbenchRecipe>
    {
        private static final ResourceLocation NAME = new ResourceLocation(SiegeMachines.MOD_ID, "siege_workbench");
        ...
        public SiegeWorkbenchRecipe fromJson(ResourceLocation p_199425_1_, JsonObject p_199425_2_)
        {
            ...
            Map<String, Ingredient> map = SiegeWorkbenchRecipe.keyFromJson(GsonHelper.getAsJsonObject(p_199425_2_, "key"));
            String[] astring = SiegeWorkbenchRecipe.shrink(SiegeWorkbenchRecipe.patternFromJson(GsonHelper.getAsJsonArray(p_199425_2_, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = SiegeWorkbenchRecipe.dissolvePattern(astring, map, i, j);
            ItemStack itemstack = SiegeWorkbenchRecipe.itemFromJson(GsonHelper.getAsJsonObject(p_199425_2_, "result"));
            return new SiegeWorkbenchRecipe(p_199425_1_, s, i, j, nonnulllist, itemstack);
        }

        public SiegeWorkbenchRecipe fromNetwork(ResourceLocation p_199426_1_, FriendlyByteBuf p_199426_2_)
        {
        ...
        public void toNetwork(FriendlyByteBuf p_199427_1_, SiegeWorkbenchRecipe p_199427_2_)
        {
